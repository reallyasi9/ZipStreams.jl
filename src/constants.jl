...
const UNIX_IFREG = UInt32(0o100000)
const UNIX_IFDIR = UInt32(0o040000)
const UNIX_IFIFO = UInt32(0o010000)
const UNIX_IRUSR = UInt32(0o000400)
const UNIX_IWUSR = UInt32(0o000200)
const UNIX_IXUSR = UInt32(0o000100)